...
<?php if (have_posts()): while (have_posts()): the_post(); ?>
		<main class="container contatos">
			...
			<address>
				<h3>Filme B</h3>
				<p>Rua Alcindo Guanabara, 24 / 504</p>
				<p>Centro - Rio de Janeiro - CEP: 20031-130</p>
				<a href="mailto:filmeb@filmeb.com.br">filmeb@filmeb.com.br</a>
			</address>
			<h3 class="titulo">Diretoria</h3>
			<div class="grid grid-3-lg gap-32">
				<div class="card-user">
					<img src="<?php echo get_template_directory_uri(); ?>/assets/images/contatos/paulo.png" alt="Paulo Sérgio Almeida" />
					<div>
				...
				<div class="card-user">
					<img src="<?php echo get_template_directory_uri(); ?>/assets/images/contatos/rodigo.png" alt="Rodrigo Saturnino Braga" />
					<div>
						<h4>Rodrigo Saturnino Braga</h4>
						<a href="mailto:rodrigo@filmeb.com.br">rodrigo@filmeb.com.br</a>
					</div>
				</div>
				<div class="card-user">
					<img src="<?php echo get_template_directory_uri(); ?>/assets/images/contatos/cristina.png" alt="Cristina Siaines" />
					<div>
			...
			<div class="grid grid-3-lg gap-32" style="margin: 35px 0;">
				<div class="card-user">
					...
					<div class="item">
						<img src="<?php echo get_template_directory_uri(); ?>/assets/images/contatos/Elizabeth.png" alt="Elizabeth Ribeiro" />
						<div>
					...
					<div class="item">
						<img src="<?php echo get_template_directory_uri(); ?>/assets/images/contatos/Cristiane.png" alt="Cristiane Denik" />
						<div>
				...
				<div class="card-user">
					...
					<div class="item">
						<img src="<?php echo get_template_directory_uri(); ?>/assets/images/contatos/Fabiano.png" alt="Fabiano Ristow" />
						<div>
							<span>Editor</span>
					...
					<div class="item">
						<img src="<?php echo get_template_directory_uri(); ?>/assets/images/contatos/Beatriz.png" alt="Beatriz Filippo" />
						<div>
							<span>Repórter e coordenadora do Calendário de Estreias</span>
							<h4>Beatriz Filippo</h4>
							<a href="mailto:beatriz@filmeb.com.br">beatriz@filmeb.com.br</a>
						</div>
					</div>
				</div>
				<div class="card-user">
